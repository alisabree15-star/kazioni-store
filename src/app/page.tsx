...
export default function Home() {
  ...
  const products = [
    ...
    { id: 17, name: "آلة تصوير 360° الدوارة 📸", img: "/images/product17.jpg", price: "460 $", pColor: "text-amber-600", shippingNote: "السعر شامل العمولة فقط (لا يشمل الشحن)", description: "ارتقِ بتجربة التصوير في أحداثك ومناسباتك مع آلة تصوير كشك 360° الاحترافية (360 Photo Booth). يتميز هذا الطراز بقطر منصة مريح يبلغ 80 سم، مما يسمح بتصوير مجموعة من الأشخاص بسهولة وأمان. المنصة مزودة بإضاءة LED سفلية مذهلة (تدرج ألوان) لخلق تأثيرات بصرية ساحرة. الذراع الدوار القابل للتعديل يحمل حلقة إضاءة RGB مدمجة لضمان إضاءة مثالية ومتساوية من جميع الزوايا ومقاطع فيديو عالية الجودة. مثالية لحفلات الزفاف، أعياد الميلاد، المهرجانات، إطلاق المنتجات، والمزيد.", moq: "5 قطع", cbm: "0.450", weight: "65" }
  ];
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-right font-sans text-black pb-32 relative" dir="rtl">
      ...
      {/* قسم الحوالات المالية التفاعلي (تصميم أنيق وأبيض) 💸 */}
