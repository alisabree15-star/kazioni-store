    ...
    <main className="min-h-screen bg-gray-50 text-right font-sans text-black pb-32" dir="rtl">
      ...
      <section className="p-6 max-w-md mx-auto mt-2 text-black">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 mb-4 overflow-hidden">
          ...
          {isAirOpen && (
            <div className="p-5 space-y-3 bg-blue-50/50 border-t border-blue-100 font-bold">
    ...
    <main className="min-h-screen bg-gray-50 text-right font-sans text-black pb-32" dir="rtl">
      ...
      <section className="p-6 max-w-md mx-auto mt-2 text-black">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          {isSeaOpen && (
            <div className="p-5 space-y-3 bg-teal-50/50 border-t border-teal-100 font-bold">
