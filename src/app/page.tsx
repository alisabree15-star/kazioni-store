...
export default function Home() {
  ...
  const products = [
    ...
    { id: 12, name: "ماكينة رش الأسمنت والطلاء الحديثة 🏗️", img: "/images/product12.jpg", price: "1100 $", pColor: "text-amber-600", shippingNote: "السعر شامل العمولة فقط (لا يشمل الشحن)", description: "ماكينة رش احترافية عالية الضغط (Airless Sprayer) موديل 1095، مصممة لأعمال البناء والتشطيبات الثقيلة. مثالية لرش الأسمنت، المعجون، والطلاء بكفاءة وسرعة فائقة. تتميز بمحرك جبار، وهيكل معدني متين مزود بعجلات لسهولة التنقل في مواقع العمل، مما يوفر الوقت والمجهود للمقاولين والمهندسين.", moq: "1 قطعة", cbm: "0.250", weight: "45" }
  ];
