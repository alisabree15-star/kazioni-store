...
export default function Home() {
  ...
  const products = [
    ...
    { 
      id: 8, 
      name: "ماكينة التنظيف بالثلج الجاف 👀", 
      img: "/images/product8.jpg", 
      price: "1400 $", 
      pColor: "text-amber-600",
      shippingNote: "شامل الشحن والعمولة إلى ليبيا (شحن بحري فقط 🚢)",
      description: "ماكينة تنظيف صناعية متطورة بتقنية الثلج الجاف (Dry Ice Blasting) من Crodium. تتميز بهيكل معدني صلب شديد التحمل ومزودة بعجلات لسهولة التنقل في الورش. تحتوي على لوحة تحكم دقيقة مع مقياس لضغط الهواء ومفتاح طوارئ. تعتبر الحل الأمثل والآمن لتنظيف المحركات وإزالة الشحوم الكربونية المستعصية للمعدات الصناعية دون استخدام قطرة ماء أو مواد كيميائية.",
      moq: "1 قطعة",
      cbm: "0.450",
      weight: "75"
    }
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-right font-sans text-black pb-32" dir="rtl">
      ...
      <section className="p-6 max-w-md mx-auto pt-2 text-black">
        <h3 className="text-xl font-bold text-gray-800 mb-4 border-r-4 border-orange-500 pr-3 text-black">وصل حديثاً 🇨🇳</h3>
