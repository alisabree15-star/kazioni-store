...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-right font-sans text-black pb-32 relative" dir="rtl">
      ...
      {/* 2. الشريط الأحمر المتحرك للتنبيه */}
      <div className="bg-red-600 text-white p-2 overflow-hidden shadow-inner border-b border-red-700">
        <div className="animate-marquee font-bold text-sm">
          تنويه هام: يرجى التحقق من أسعار الصرف اليومية قبل إتمام أي طلبات شحن أو حوالات مالية.
        </div>
      </div>
